...
<body>
    <div class="container">
        ...
        <form action="sistemaFornecedor/formCidade/controleAtualizarA.jsp" method="POST" id="register-form">
            <div class="user-detail">
               
                <div class="input-box">
                    <span class="detail">ID da Cidade:</span>
                    <input type="text" name="idcidade" placeholder="Não Precisa Preencher" readonly="readonly" value="${cidade.idCidade }" class="outrosIn"  required>
                </div>
                <div class="input-box">
                    <span class="detail">Nome da Cidade:</span>
                    <input type="text" name="nome" placeholder="Digite o nome da cidade" value="${cidade.nome}" required>
                </div>
                <div class="input-box">
                    <span class="detail">População:</span>
                    <input type="text" name="populacao" placeholder="Digite o número da população" value="${cidade.populacao}"required>
                </div>
                
               
                <div class="input-box">
                    <span class="detail">Província:</span>
                    <input type="text" name="provincia" id="email" value="${cidade.provicia}" placeholder="Digite a província em que a cidade se encontra" required>
                </div>
