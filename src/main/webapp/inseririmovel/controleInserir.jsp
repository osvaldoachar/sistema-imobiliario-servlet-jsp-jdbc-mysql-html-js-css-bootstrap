...
<body>
	...
	// String telefone = request.getParameter("telefone");
	 ...
	 imo.InserirImovelDao(nome, nomeAbreviado, endereco, email, fChave, cChave);
	 
	%>

	
	<script type="text/javascript">
	window.location.href="http://localhost:8080/sistema-imobiliario/sistemaFornecedor/imovel.jsp"
	</script>
</body>
</html>