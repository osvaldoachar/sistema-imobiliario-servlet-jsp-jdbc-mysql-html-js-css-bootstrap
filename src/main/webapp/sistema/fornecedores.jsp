            ...
            <li class="nav-item nav-profile dropdown">
              ...
              <div class="dropdown-menu navbar-dropdown" aria-labelledby="profileDropdown">
                <a class="dropdown-item" href="#">
                  <i class="mdi mdi-table-edit" style="margin-right: 5px; font-size: 20px; color: red;"></i> Editar Perfil</a>
      ...
      <div class="container-fluid page-body-wrapper">
          ...
          <ul class="nav">
            ...
            <li class="nav-item">
              <a class="nav-link" data-bs-toggle="collapse" href="#ui-basic" aria-expanded="false" aria-controls="ui-basic">
                <span class="menu-title" style="color: red;">Membros</span>
                <i class="menu-arrow" style="color: red;"></i>
                <i class="mdi mdi-account-multiple"  style=" font-size: 22px; color:red;"></i>
              </a>
              <div class="collapse" id="ui-basic">
                <ul class="nav flex-column sub-menu">
                  <li class="nav-item"> <a class="nav-link" href="fornecedores.jsp" style="color: red;">Fornecedores</a></li>
                </ul>
              </div>
            </li>
        ...
        <div class="main-panel">
          <div class="content-wrapper">
           ...
           <a href="formFornecedor/inserirFornecedor.jsp"><button type="button" class="btn btn-gradient-info btn-fw" style="background: red;">Novo Fornecedor</button></a>
            </div>
                  ...
                  <table class="table table-bordered" >
                    ...
                    <tbody>
                      <tr>
                        ...
                        <td><%=f.getEmail() %></td>
                        <td><%=f.getTelefone() %></td>
                        <th class="valores"><a href="../FornecedorServlet?acao=alterar&codigo=<%=f.getCodigo() %>" class="atualiza"><i class="mdi mdi-rename-box" style="color:red; border:none; margin-right:10px" ></i></a>
