...
<html lang="pt">
  <head>
    ...
    function confirmarExclusao(codigo, nome){
    	if(confirm('Desejas excluir a cidade '+nome+'?')){
    		
    		location.href='../CidadeServletA?acao=deletar&codigo='+codigo;
    	}
    }
      ...
      <div class="container-fluid page-body-wrapper">
          ...
          <ul class="nav">
            ...
            <li class="nav-item">
              ...
              <div class="collapse" id="general-pages">
                <ul class="nav flex-column sub-menu">
                  <li class="nav-item"> <a class="nav-link" href="cidades.jsp"  style="color: red;"> Cidades </a></li>
        ...
        <div class="main-panel">
          <div class="content-wrapper">
           ...
           <a href="../sistemaFornecedor/formCidade/inserirCidadeA.jsp"><button type="button" class="btn btn-gradient-info btn-fw" style="background: red;">Nova Cidade</button></a>
            </div>
                   ...
                   <table class="table table-bordered" >
                    ...
                    <tbody>
                      <tr>
                        ...
                        <td><%=c.getPopulacao() %> Habitantes</td>
                        <td><%=c.getProvicia()%></td>
                    
                        <th class="valores"><a href="../CidadeServletA?acao=alterar&codigo=<%=c.getIdCidade() %>" class="atualiza"><i class="mdi mdi-rename-box" style="color:red; border:none; margin-right:10px" ></i></a>
                      <button class="exclui" onclick="confirmarExclusao(<%= c.getIdCidade() %>, '<%= c.getNome() %>')" style="border:none;"><i class="mdi mdi-delete-forever" style="color:red; border:none;" ></i></button></th>
