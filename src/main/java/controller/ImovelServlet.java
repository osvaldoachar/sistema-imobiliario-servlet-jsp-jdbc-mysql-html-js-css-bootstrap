	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			if(acao.equals("alterar")) {
				...
				if(i.getIdimovel()>0) {
					RequestDispatcher disp = getServletContext().getRequestDispatcher("/inseririmovel/atualizarImovel.jsp");
		...
		out.println("window.location.href=\"http://localhost:8080/sistema-imobiliario/sistemaFornecedor/imovel.jsp\"");
		out.println("</script>");
