	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			if(acao.equals("alterar")) {
				...
				if(c.getIdCidade()>0) {
					RequestDispatcher disp = getServletContext().getRequestDispatcher("/sistemaFornecedor/formCidade/atualizarCidade.jsp");
		...
		out.println("window.location.href=\"http://localhost:8080/sistema-imobiliario/sistemaFornecedor/cidades.jsp\"");
		out.println("</script>");
